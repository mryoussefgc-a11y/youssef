...
<section class="section-pad">
    <div class="container">
      <div class="matchday-intro reveal">
        <span class="eyebrow">Built for match day</span>
        <h2 style="font-size:clamp(2rem,4.4vw,3.1rem);font-weight:800;letter-spacing:-0.035em;line-height:1.06;color:#fff;">Never Miss The Big Moments</h2>
        <div class="lines">
          When the Premier League kicks off, on a Champions League night, or when the main fight card starts —
          <span class="em">that's when most IPTV services fail. Ours is built to stay stable.</span>
        </div>
      </div>
      <div class="sports-grid">
        <div class="sport-card reveal"><span class="sp-bg s1"><img src="images/premier-league.jpg" alt=""></span><span class="sp-live"><span class="d"></span> LIVE</span><h4>Premier League</h4><small>Full match-day coverage</small></div>
        <div class="sport-card reveal"><span class="sp-bg s2"><img src="images/champions-league.jpg" alt=""></span><span class="sp-live"><span class="d"></span> LIVE</span><h4>Champions League</h4><small>Midweek nights</small></div>
        <div class="sport-card reveal"><span class="sp-bg s3"><img src="images/boxing.jpg" alt=""></span><span class="sp-live"><span class="d"></span> LIVE</span><h4>Boxing</h4><small>Every fight night</small></div>
        <div class="sport-card reveal"><span class="sp-bg s4"><img src="images/ufc.jpg" alt=""></span><span class="sp-live"><span class="d"></span> LIVE</span><h4>UFC</h4><small>Main events</small></div>
      </div>
    </div>
  </section>
  ...
  <section class="section-pad" id="contact">
    <div class="container">
      <div class="final-banner reveal">
        ...
        <a href="https://wa.me/1234567890" target="_blank" rel="noopener" class="btn btn-light btn-lg"><i class="fa-brands fa-whatsapp"></i> Message Us On WhatsApp</a>
        <p class="note">No commitment. Cancel anytime.</p>
      </div>
    </div>
  </section>

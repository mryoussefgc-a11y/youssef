      ...
      <div class="footer-grid">
        <div>
          <a href="<?php echo $home; ?>" class="logo">
            <img src="<?php echo iptv_media( 'iptv_footer_logo', 'https://s3-eu-west-1.amazonaws.com/tpd/logos/690ba9cc3ef46c785bd2c9c6/0x0.png' ); ?>" alt="IPTV Trusted" style="height:44px;width:auto;display:block;">
          </a>
